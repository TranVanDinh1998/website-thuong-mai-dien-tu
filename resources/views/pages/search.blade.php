@extends('layout')
@section('title', 'Search - Electronical Store')
@section('content')
    <!-- breadcrumbs -->
        ...
        <div class="container">
            <div class="row">
                <ul>
                    ...
                    <li class="category13"><strong>Search - {{ $search }}</strong></li>
                </ul>
            </div>
        </div>
    </div>
        ...
        <div class="main container">
            <div class="row">
                        ...
                        <div class="toolbar">
                            ...
                            <div id="sort-by">
                                ...
                                <ul>
                                    <li>
                                        <a
                                            href="{{ route('search', ['search' => $search, 'sort' => 0, 'view' => $view, 'producer_id' => $producer_id, 'price_from' => $price_from, 'price_to' => $price_to]) }}">Position<span
                                                class="right-arrow"></span>
                                        </a>
                                        <ul>
                                            <li><a
                                                    href="{{ route('search', ['search' => $search, 'sort' => 1, 'view' => $view, 'producer_id' => $producer_id, 'price_from' => $price_from, 'price_to' => $price_to]) }}">Name</a>
                                            </li>
                                            <li><a
                                                    href="{{ route('search', ['search' => $search, 'sort' => 2, 'view' => $view, 'producer_id' => $producer_id, 'price_from' => $price_from, 'price_to' => $price_to]) }}">Price</a>
                                            </li>
                                            <li><a
                                                    href="{{ route('search', ['search' => $search, 'sort' => 3, 'view' => $view, 'producer_id' => $producer_id, 'price_from' => $price_from, 'price_to' => $price_to]) }}">Rating</a>
                                            </li>
                                            <li><a
                                                    href="{{ route('search', ['search' => $search, 'sort' => 4, 'view' => $view, 'producer_id' => $producer_id, 'price_from' => $price_from, 'price_to' => $price_to]) }}">Seller</a>
                                            </li>
                                        </ul>
                                    </li>
                                </ul>
                ...
                <aside class="col-left sidebar col-sm-3 col-xs-12 col-sm-pull-9 wow">
                    ...
                    {{-- <div class="block block-banner"><a href="#"><img src="{{ url('images/block-banner.png') }}"
                                alt="block-banner"></a>
                    </div> --}}
                </aside>
