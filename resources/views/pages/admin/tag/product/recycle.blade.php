        ...
        <section class="wrapper">
            ...
            <div class="table-agile-info">
                <div class="panel panel-default">
                    ...
                    <div class="row w3-res-tb">
                        <div class="col-sm-5 m-b-xs">
                            <span class="btn-group">
                                <a href="{{ route('admin.tag.product.recycle',['id'=>$tag->id]) }}" class="btn btn-sm btn-default"><i
                        ...
                        <div class="col-sm-5">
                            <form enctype="multipart/form-data" method="GET"
                                action="{{ route('admin.tag.product.recycle',['id'=>$tag->id]) }}">
                    ...
                    <form method="GET" action="{{ route('admin.tag.product.bulk_action',['id'=>$tag->id]) }}" enctype="multipart/form-data">
                        <div class="row w3-res-tb">
                            <div class="col-sm-5 m-b-xs">
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <ul class="dropdown-menu">
                                                    <li @if ($sort_id == 0) class="active" @endif><a
                                                            href="{{ route('admin.tag.product.recycle', ['id'=>$tag->id,'sort_id' => 0, 'status' => $status, 'view' => $view]) }}">Inc</a>
                                                    </li>

                                                    <li @if ($sort_id == 1) class="active" @endif><a
                                                            href="{{ route('admin.tag.product.recycle', ['id'=>$tag->id,'sort_id' => 1, 'status' => $status, 'view' => $view]) }}">Desc</a>
                                                    </li>
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <ul class="dropdown-menu">
                                                    <li @if ($status == null) class="active" @endif><a
                                                            href="{{ route('admin.tag.product.recycle', ['id'=>$tag->id,'sort_id' => $sort_id, 'view' => $view]) }}">Tất cả</a>
                                                    </li>
                                                    <li @if ($status == 1) class="active" @endif><a
                                                            href="{{ route('admin.tag.product.recycle', ['id'=>$tag->id,'sort_id' => $sort_id, 'status' => '1', 'view' => $view]) }}">Hoạt động</a>
                                                    </li>

                                                    <li @if ($status == 0 && $status != null) class="active" @endif><a
                                                            href="{{ route('admin.tag.product.recycle', ['id'=>$tag->id,'sort_id' => $sort_id, 'status' => '0', 'view' => $view]) }}">Ngừng hoạt động</a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </th>
                                ...
                                <tbody>
                                    @foreach ($tagProducts as $tagProduct)
                                        ...
                                        <td>
                                            ...
                                            <td><span class="text-ellipsis">{{ $tagProduct->deleted_at }}</span></td>
                                            <td>
                                            ...
                                            <td>
                                                <a onclick="return confirm('Are you sure?')"
                                                    href="{{ route('admin.tag.product.restore', ['id' => $tag->id,'product_id'=>$tagProduct->id, 'verified' => 1]) }}"
                                                    class="btn btn-success"><span class="glyphicon glyphicon-check"></span>
                                                </a>
                                            </td>
                                            <td>
                                                <a onclick="return confirm('Are you sure?')"
                                                    href="{{ route('admin.tag.product.destroy', ['id' => $tag->id,'product_id'=>$tagProduct->id, 'verified' => 1]) }}"
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu">
                                            <li @if ($view == 10) class="active" @endif><a
                                                    href="{{ route('admin.tag.product.recycle', ['id' => $tag->id,'sort_id' => $sort_id, 'status' => $status, 'view' => 10]) }}">10</a>
                                            </li>
                                            <li @if ($view == 15) class="active" @endif><a
                                                    href="{{ route('admin.tag.product.recycle', ['id' => $tag->id,'sort_id' => $sort_id, 'status' => $status, 'view' => 15]) }}">15</a>
                                            </li>
                                            <li @if ($view == 20) class="active" @endif><a
                                                    href="{{ route('admin.tag.product.recycle', ['id' => $tag->id,'sort_id' => $sort_id, 'status' => $status, 'view' => 20]) }}">20</a>
                                            </li>
                                            <li @if ($view == 30) class="active" @endif><a
                                                    href="{{ route('admin.tag.product.recycle', ['id' => $tag->id,'sort_id' => $sort_id, 'status' => $status, 'view' => 30]) }}">30</a>
                                            </li>
                                            <li @if ($view == 40) class="active" @endif><a
                                                    href="{{ route('admin.tag.product.recycle', ['id' => $tag->id,'sort_id' => $sort_id, 'status' => $status, 'view' => 40]) }}">40</a>
                                            </li>
