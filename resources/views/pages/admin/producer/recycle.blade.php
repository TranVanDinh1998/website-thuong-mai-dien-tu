...
@section('content')
    ...
    <section id="main-content">
        <section class="wrapper">
            <ol class="breadcrumb">
                <li><a href="{{ route('admin.producer.index') }}">Hãng</a></li>
                    ...
                    <div class="row w3-res-tb">
                        ...
                        <div class="col-sm-5">
                            <form enctype="multipart/form-data" method="GET"
                                action="{{ route('admin.producer.recycle') }}">
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <ul class="dropdown-menu">
                                                    <li @if ($status == null) class="active" @endif><a
                                                            href="{{ route('admin.producer.recycle', ['sort_id' => $sort_id, 'view' => $view]) }}">Tất cả</a>
                                                    </li>
                                                    <li @if ($status == 1) class="active" @endif><a
                                                            href="{{ route('admin.producer.recycle', ['sort_id' => $sort_id, 'status' => '1', 'view' => $view]) }}">Hoạt động</a>
                                                    </li>

                                                    <li @if ($status == 0 && $status != null) class="active" @endif><a
                                                            href="{{ route('admin.producer.recycle', ['sort_id' => $sort_id, 'status' => '0', 'view' => $view]) }}">Ngừng hoạt động</a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </th>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <img style="width: 70px; height : auto"
                                                    src="{{ asset('/storage/images/producers/' . $producer->image) }}"
                                                    alt="{{ $producer->name }}">
                                            </td>
                                            <td><span class="text-ellipsis">{{ $producer->name }}</span></td>
                                            <td><span class="text-ellipsis">{{ $producer->deleted_at }}</span></td>
                                            <td>
                                                @if ($producer->verified == 1)
                                            ...
                                            <td>
                                                <a onclick="return confirm('Are you sure?')"
                                                    href="{{ route('admin.producer.destroy', ['id' => $producer->id]) }}"
