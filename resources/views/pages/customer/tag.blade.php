        ...
        <div class="container">
            <div class="row">
                <ul>
                    ...
                    @if ($tag != null)
                        <li class="category13"><strong>Thẻ - {{ $tag->name }}</strong></li>
                    @endif
                </ul>
            </div>
        </div>
                        ...
                        <div class="toolbar">
                            <div class="sorter">
                                <div class="view-mode">
                                    ...
                                    sách" class="button button-list">Dạng danh
                                        sách</button>
                                    <button id="btn_filter_grid" title="Dạng lưới" class="button button-grid">Dạng lưới</button>
                                </div>
                            </div>
                            <div id="sort-by">
                                ...
                                <ul>
                                    <li>
                                        <a
                                            href="{{ route('tag', ['tag_id' => $tag_id, 'sort' => 0, 'view' => $view, 'producer_id' => $producer_id, 'price_from' => $price_from, 'price_to' => $price_to]) }}">Vị
                                            trí<span
                                                class="right-arrow"></span>
                                        </a>
                                        <ul>
                                            <li><a
                                                    href="{{ route('tag', ['tag_id' => $tag_id, 'sort' => 1, 'view' => $view, 'producer_id' => $producer_id, 'price_from' => $price_from, 'price_to' => $price_to]) }}">Tên</a>
                                            </li>
                                            <li><a
                                                    href="{{ route('tag', ['tag_id' => $tag_id, 'sort' => 2, 'view' => $view, 'producer_id' => $producer_id, 'price_from' => $price_from, 'price_to' => $price_to]) }}">Giá
                                                    cả</a>
                                            </li>
                                            <li><a
                                                    href="{{ route('tag', ['tag_id' => $tag_id, 'sort' => 3, 'view' => $view, 'producer_id' => $producer_id, 'price_from' => $price_from, 'price_to' => $price_to]) }}">Xếp
                                                    hạng</a>
                                            </li>
                                            <li><a
                                                    href="{{ route('tag', ['tag_id' => $tag_id, 'sort' => 4, 'view' => $view, 'producer_id' => $producer_id, 'price_from' => $price_from, 'price_to' => $price_to]) }}">Bán
                                                    chạy</a>
                                            </li>
                                        </ul>
                                    </li>
                            ...
                            <div class="pager">
                                <div id="limiter">
                                    ...
                                    <ul>
                                        <li><a
                                                href="{{ route('tag', ['tag_id' => $tag_id, 'sort' => $sort, 'view' => 15, 'producer_id' => $producer_id, 'price_from' => $price_from, 'price_to' => $price_to]) }}">15<span
                                                    class="right-arrow"></span>
                                            </a>
                                            <ul>
                                                <li><a
                                                        href="{{ route('tag', ['tag_id' => $tag_id, 'sort' => $sort, 'view' => 20, 'producer_id' => $producer_id, 'price_from' => $price_from, 'price_to' => $price_to]) }}">20
                                                    </a>
                                                </li>
                                                <li><a
                                                        href="{{ route('tag', ['tag_id' => $tag_id, 'sort' => $sort, 'view' => 30, 'producer_id' => $producer_id, 'price_from' => $price_from, 'price_to' => $price_to]) }}">30
                                                    </a>
                                                </li>
                                                <li><a
                                                        href="{{ route('tag', ['tag_id' => $tag_id, 'sort' => $sort, 'view' => 35, 'producer_id' => $producer_id, 'price_from' => $price_from, 'price_to' => $price_to]) }}">35
                                                    </a>
                                                </li>
                                            </ul>
                                        </li>
                        ...
                        <div class="block-content">
                            ...
                            <dl id="narrow-by-list">
                                ...
                                <dd class="odd">
                                    <ol>
                                        <li> <a
                                                href="{{ route('tag', ['tag_id' => $tag_id, 'producer_id' => $producer_id, 'sort' => $sort, 'view' => $view, 'price_to' => 500000]) }}"><span
                                                    class="price">0</span> - <span class="price">500000
                                                    <small>d</small></span></a>
                                        </li>
                                        <li> <a
                                                href="{{ route('tag', ['tag_id' => $tag_id, 'producer_id' => $producer_id, 'sort' => $sort, 'view' => $view, 'price_from' => 500000, 'price_to' => 1000000]) }}"><span
                                                    class="price">500000</span> - <span class="price">1000000
                                                    <small>d</small></span></a>
                                        </li>
                                        <li> <a
                                                href="{{ route('tag', ['tag_id' => $tag_id, 'producer_id' => $producer_id, 'sort' => $sort, 'view' => $view, 'price_from' => 1000000, 'price_to' => 2000000]) }}"><span
                                                    class="price">1000000</span> - <span class="price">2000000
                                                    <small>d</small></span></a>
                                        </li>
                                        <li> <a
                                                href="{{ route('tag', ['tag_id' => $tag_id, 'producer_id' => $producer_id, 'sort' => $sort, 'view' => $view, 'price_from' => 2000000, 'price_to' => 5000000]) }}"><span
                                                    class="price">2000000</span> - <span class="price">5000000
                                                    <small>d</small></span></a>
                                        </li>
                                        <li> <a
                                                href="{{ route('tag', ['tag_id' => $tag_id, 'producer_id' => $producer_id, 'sort' => $sort, 'view' => $view, 'price_from' => 5000000]) }}"><span
                                ...
                                <dd class="even">
                                    <ol>
                                        @foreach ($producers as $producer)
                                            <li> <a
                                                    href="{{ route('tag', ['tag_id' => $tag_id, 'producer_id' => $producer->id, 'sort' => $sort, 'view' => $view, 'price_from' => $price_from, 'price_to' => $price_to]) }}">{{ $producer->name }}</a>
