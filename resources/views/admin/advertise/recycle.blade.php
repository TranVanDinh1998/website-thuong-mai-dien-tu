            ...
            <div class="table-agile-info">
                <div class="panel panel-default">
                        ...
                        <div class="row w3-res-tb">
                            ...
                            <div class="col-sm-5">
                                <form enctype="multipart/form-data" method="GET" action="{{ route('admin.advertise.recycle') }}">
                                    ...
                                    <tr>
                                        ...
                                        <th>
                                            <div class="dropdown">
                                                ...
                                                <ul class="dropdown-menu">
                                                    <li><a
                                                            href="{{ route('admin.advertise.recycle', ['sort_id' => $sort_id, 'view' => $view]) }}">All</a>
                                                    </li>
                                                    <li><a
                                                            href="{{ route('admin.advertise.recycle', ['sort_id' => $sort_id, 'status' => '1', 'view' => $view]) }}">Active</a>
                                                    </li>

                                                    <li><a
                                                            href="{{ route('admin.advertise.recycle', ['sort_id' => $sort_id, 'status' => '0', 'view' => $view]) }}">Inactive</a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </th>
