...
@section('content')
        ...
        <section class="wrapper">
            ...
            <section class="panel">
                <div class="panel-heading">
                    Add product to collection {{$collection->name}}
                </div>
                <div class="panel-body">
                    <div class="position-center">
                        <form id="add_collection_product_form" enctype="multipart/form-data" method="POST"
                            action="{{ route('admin.collection.product.doAdd',['id'=>$collection->id]) }}">
                            @csrf
    ...
    <script>
        jQuery(document).ready(function($) {
            ...
            $('#add_collection_product_form').on('submit', (function(e) {
                ...
                $.ajax({
                    url: "{{ route('admin.collection.product.doAdd',['id'=>$collection->id]) }}",
                    type: 'POST',
