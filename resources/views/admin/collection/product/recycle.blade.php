...
@section('content')
    ...
    <section id="main-content">
        <section class="wrapper">
            <ol class="breadcrumb">
                <li><a href="{{ route('admin.collection.index', ['id' => $collection->id]) }}">Collection
                        management</a></li>
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <ul class="dropdown-menu">
                                                    <li @if ($status == null)
                                                        ...
                                                        @endif
                                                        ><a
                                                            href="{{ route('admin.collection.product.recycle', ['id' => $collection->id, 'sort_id' => $sort_id, 'view' => $view]) }}">All</a>
                                                    </li>
                                                    <li @if ($status == 1)
                                                        class="active"
                                                        @endif
                                                        ><a
                                                            href="{{ route('admin.collection.product.recycle', ['id' => $collection->id, 'sort_id' => $sort_id, 'status' => '1', 'view' => $view]) }}">Active</a>
                                                    </li>
                                                    <li @if ($status == 0 && $status != null)
                                                        class="active"
                                                        @endif
                                                        ><a
                                                            href="{{ route('admin.collection.product.recycle', ['id' => $collection->id, 'sort_id' => $sort_id, 'status' => '0', 'view' => $view]) }}">Inactive</a>
                                                    </li>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a onclick="return confirm('Are you sure?')"
                                                            href="{{ route('admin.collection.product.restore', ['id' => $collection->id, 'product_id' => $collection_product->id]) }}"
                                                    ...
                                                    <td>
                                                        <a onclick="return confirm('Are you sure?')"
                                                            href="{{ route('admin.collection.product.delete', ['id' => $collection->id, 'product_id' => $collection_product->id]) }}"
