...
@section('title', 'Add new producer')
@section('head')
...
@section('content')
            ...
            <section class="panel">
                ...
                <div class="panel-body">
                    <div class="position-center">
                        <form id="add_producer_form" enctype="multipart/form-data" method="POST"
                            action="{{ route('admin.producer.doAdd') }}">
                            @csrf
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" name="number" placeholder="name">
                            </div>
                            <div class="form-group">
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#add_producer_form').on('submit', (function(e) {
                ...
                $.ajax({
                    url: "{{ route('admin.producer.doAdd') }}",
                    type: 'POST',
